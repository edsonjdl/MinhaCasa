                ...
                <asp:Table ID="Table1" border="1" Height="100%" Width="100%" runat="server">
                    ...
                    <asp:TableRow>
                        <asp:TableCell ColumnSpan="2">
                            ...
                            <asp:RequiredFieldValidator id="Req1" ControlToValidate="tituloLivro" Text="Você esqueceu de escrever o título." BackColor="Yellow" runat=server/>
                    ...
                    <asp:TableRow>
                        <asp:TableCell ColumnSpan="2">
                            ...
                            <asp:RequiredFieldValidator id="Req2" ControlToValidate="listaIdiomas" InitialValue="Toque aqui para escolher o idioma" Text="Você esqueceu de escolher o idioma do livro." BackColor="Yellow" runat=server/>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell ColumnSpan="2">
                    ...
                    <asp:TableRow>
                        <asp:TableCell ColumnSpan="2">
                            ...
                            <asp:RequiredFieldValidator id="Req31" ControlToValidate="nPaginas" Text="Você esqueceu de colocar o número de páginas." BackColor="Yellow" runat=server/>
                            <asp:CompareValidator ID="Comp32" runat="server" Text="Isso não é um número" BackColor="Yellow" ControlToValidate="nPaginas" Type="Integer" Operator="DataTypeCheck" />
                        </asp:TableCell>
                    </asp:TableRow>
                    ...
                    <asp:TableRow ID="rowTablet2">
                        ...
                        <asp:FileUpload ID="ImageUpload" runat="server" />
                            <asp:RequiredFieldValidator id="Req4" ControlToValidate="ImageUpload" Text="Você esqueceu de tirar a foto da capa do livro." BackColor="Yellow" runat=server/>
                            </asp:TableCell>
                    </asp:TableRow>
